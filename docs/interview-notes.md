...
* **Token**: The structured metadata representation of that lexeme produced by the scanner. It consists of:
  * A `TokenType` (e.g., `TOKEN_VAR`, `TOKEN_NUMBER`, `TOKEN_IDENTIFIER`).
...
### Q6: What is the difference between a Parse Tree (CST) and an Abstract Syntax Tree (AST)?
...
### Q8: How is Operator Precedence resolved in Recursive Descent?
...
### Q9: Stack vs Heap Memory — What is the difference?
...
### Q10: What are Common C Memory Bugs and How Do We Prevent Them?
...
### Q11: What is a Tagged Union in C?
...
### Q12: How is the Visitor Pattern implemented in C?
